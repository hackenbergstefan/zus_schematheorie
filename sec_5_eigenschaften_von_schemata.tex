...
\begin{definition}[(lokal) noethersch]
    \index[def]{Definition!Schema!noethersch}
    \index[def]{Definition!Schema!noethersch!lokal noethersch}
...
\begin{definition}[algebraische/projektive $k$-Varietät]
    \index[def]{Definition!Varietät!algebraische}
    \index[def]{Definition!Varietät!projektive}
...
\begin{definition}[reduzierte Ringe]
    \index[def]{Definition!Ring!reduziert}
...
\begin{definition}[reduzierte lokal geringte Räume]
    \index[def]{Definition!lokal geringter Raum!reduziert}
...
\begin{definition}[Garbifizierung]
    \index[def]{Definition!Garbifizierung}
