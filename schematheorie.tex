...
\ifnum\myDevelopVariable=1 
  ...
  %\newtheorem{case}{Fall}
\else
  \usepackage[hideproof=true]{tikztheorems}
  \newtikztheorem[
    style=elegantbreak,
    color=mycolor,
...
\newenvironment{einschub}[1]{\subsubsection*{Einschub: }
    \marginpar{\ifthenelse{\isodd{\thepage}}{}{\hfill}%
        \tikz[baseline]{\fill[col1shade2]
        (-2ex,1ex) -- (2ex,1ex) -- (0,-1ex) -- cycle;}}}
    {\marginpar{\ifthenelse{\isodd{\thepage}}{}{\hfill}%
        \tikz[baseline]{\fill[col1shade2]
        (-2ex,0) -- (2ex,0) -- (0,2ex) -- cycle;}}}
...
\input{sec_2_affine_schemata}
\input{sec_3_beispiele}
\input{sec_4_projektive_schemata}
\input{sec_5_eigenschaften_von_schemata}
\input{sec_6_faserprodukt}
\input{sec_7_glatt_regulaer_und_normal}
\input{sec_8_k-varietaet}
\input{sec_9_der_punktefunktor}
%\part{Zweites Semester}
\input{sec_10_ox_moduln}
\input{sec_11_divisoren}
\input{sec_12_garbenhohomologie}
\input{sec_13_differentiale.tex}
\pagebreak
\nocite{*}
\printbibliography
