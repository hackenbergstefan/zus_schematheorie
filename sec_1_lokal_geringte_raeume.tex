...
\begin{definition}[Morphismus von Prägarben]
    \index[def]{Definition!Morphismus von Prägarben}
...
\begin{definition}[Kategorie der (Prä-)garben]
    \index[def]{Definition!Kategorie der Prägarben}
    \index[def]{Definition!Kategorie der Garben}
...
\begin{definition}[Halm, Keim]
    \index[def]{Definition!Halm}
    \index[def]{Definition!Keim}
...
\begin{definition}[push-forward]
    \index[def]{Definition!Garbe!push-forward}
...
\begin{definition}[lokaler Ring]
    \index[def]{Definition!Ring!lokal}
...
\begin{definition}[lokal geringter Raum]
    \index[def]{Definition!lokal geringter Raum}
...
\begin{definition}[lokale Ringhomomorphismen]
    \index[def]{Definition!Lokaler Ringhomomorphismus}
...
\begin{definition}[Morphismus lokal geringter Räume]
    \index[def]{Definition!Morphismus lokal geringter Räume}
