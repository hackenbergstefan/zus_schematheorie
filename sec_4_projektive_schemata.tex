...
\begin{definition}[graduierte $A$-Algebra]
    \index[def]{Definition!Graduierte Algebra}
...
\begin{definition}[homogenes Ideal]
    \index[def]{Definition!Homogenes Ideal}
...
\begin{definition}[Zariski Topologie auf $\Proj(S)$]
    \index[def]{Definition!Zariski Topologie!auf $\Proj$}
...
\begin{definition}[basisoffenen Mengen auf $\Proj(S)$]
    \index[def]{Definition!Basisoffene Menge!auf $\Proj$}
...
\begin{definition}[homogene Lokalisierung]
    \index[def]{Definition!Lokalisierung!homogene}
	\begin{itemize}
...
\begin{definition}[offene und abgeschlossene Immersion]
    \index[def]{Definition!offene Immersion}
    \index[def]{Definition!abgeschlossene Immersion}
...
\begin{definition}[abgeschlossenes Unterschema]
    \index[def]{Definition!Abgeschlossenes Unterschema}
...
\begin{definition}[projektives Schema über $A$]
    \index[def]{Definition!Projektives Schema über $A$}
