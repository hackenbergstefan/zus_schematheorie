...
\begin{definition}[Zariski Topologie]
    \index[def]{Definition!Zariski Topologie}
...
\begin{definition}[abgeschlossener Punkt, generischer Punkt]
    \index[def]{Definition!Abgeschlossener Punkt}
    \index[def]{Definition!Generischer Punkt}
...
\begin{definition}[basisoffene Menge]
    \index[def]{Definition!Basisoffene Menge}
...
\begin{definition}[Radikalideal (radiziell)]
    \index[def]{Definition!radiziell}
...
\begin{definition}[irreduzibel]
    \index[def]{Definition!irreduzibel}
...
\begin{definition}[Nilradikal]
    \index[def]{Definition!Nilradikal}
	\[
		\Nil(A) := \sqrt{(0)}
	\]
...
\begin{definition}[(quasi)-kompakt]
    \index[def]{Definition!(quasi)-kompakt}
...
\begin{definition}[multiplikative Teilmenge, Lokalisierung]
    \index[def]{Definition!Lokalisierung}
    \index[def]{Definition!Multiplikative Teilmenge}
...
\begin{definition}[$\fr B$-(Prä)Garbe]
    \index[def]{Definition!$\fr B$-(Prä-)Garbe}
...
\begin{definition}[(affines) Schema]
    \index[def]{Definition!affines Schema}
    \index[def]{Definition!Schema}
...
\begin{definition}[Morphismus von Schemata]
    \index[def]{Definition!Morphismus von Schemata}
