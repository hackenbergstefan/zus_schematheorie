...
\begin{definition}[Diskrete Bewertung]
    \index[def]{Definition!Diskrete Bewertung}
...
\begin{definition}[Bewertungsring]
    \index[def]{Definition!Bewertungsring}
    \index[def]{Definition!Bewertungsring!diskreter}
...
\begin{definition}[Restklassenkörper eines dvr]
    \index[def]{Definition!Bewertungsring!Restklassenkörper}
