...
\begin{definition}[Bewertungsring]
    \index[def]{Bewertungsring}
    \index[def]{Bewertungsring!diskreter}
...
\begin{definition}[Restklassenkörper eines dvr]
    \index[def]{Bewertungsring!Restklassenkörper}
